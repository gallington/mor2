...
ggsave(e, filename = "./plots/cbrm_balance.png", width=2, height = 7)
```
...
# Density plots
ggplot(full.data.m, aes(x=(eco1.rs), colour=CBRM)) + geom_density()+ labs(title= "prematch")

ggplot(full.data.m, aes(x=(eco1.rs *weights), colour=CBRM)) + geom_density()+ labs(title="postmatch")
...
t.test(cbrm_0, cbrm_1)
# Density plots
ggplot(full.data.m, aes(x=(eco2.rs *weights), colour=CBRM)) + geom_density()
...
# Density plots
ggplot(full.data.tr, aes(x=(eco1.rs*weights), colour=as.factor(Trsp))) + geom_density()
...
# Density plots
ggplot(full.data.tr, aes(x=(eco2.rs*weights), colour=as.factor(Trsp))) + geom_density()
...
# Density plots
ggplot(full.data.p5, aes(x=(eco1.rs*weights), colour=p5)) + geom_density()
...
# Density plots
ggplot(full.data.p5, aes(x=(eco2.rs*weights), colour=p5)) + geom_density()
...
t.test(p6_0, p6_1)
# Density plots
ggplot(full.data.p6, aes(x=(eco1.rs*weights), colour=p6)) + geom_density()
...
ks.test(p6_0, p6_1)
# Density plots
ggplot(full.data.p6, aes(x=(eco2.rs*weights), colour=p6)) + geom_density()
...
# Density plots
ggplot(full.data.p7, aes(x=(eco1.rs*weights), colour=p7)) + geom_density()
...
# Density plots
ggplot(full.data.p7, aes(x=(eco2.rs*weights), colour=p7)) + geom_density()
...
# Density plots
ggplot(full.data.p8, aes(x=(eco1.rs*weights), colour=p8)) + geom_density()
...
# Density plots
ggplot(full.data.p8, aes(x=(eco2.rs*weights), colour=p8)) + geom_density()
...
# Density plots
ggplot(full.data.p9, aes(x=(eco1.rs*weights), colour=p9)) + geom_density()
...
ggplot(full.data.p9, aes(x=(eco2.rs*weights), colour=p9)) + geom_density()
# Means pre & post
...
# Explanatory Models: 
```{r Models}
cbrm_mod <- lm(eco.int ~ CBRM + slope, data= full.data.m, weights = full.data.m$weights)
summary(cbrm_mod)
```
