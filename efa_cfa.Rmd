...
## Eastimating predicted values:  now w new 2 factor model:
Predict values of the latent factors.
...
For now, these predicted vars are also saved as an rds as "eco.pred.latent.RDS"
And as a .csv
For now the remainder of this section is turned off:::
...
write.csv(eco.pred, file = "./data/eco.pred.latent.csv")
