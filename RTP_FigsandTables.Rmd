...
```{r}
#   THESE ARE SAME AS ABOVE IN Fig 2
    # but right now i am going to plot pred w Camp tenure, rather than pasture tenure as it is in 2--
...
a <- plot_model(hypwR, type= "pred", 
           terms = c("cogSC1", "Rule", "hhTenureWCamp"), 
           colors= "bw", 
           ci.lvl = NA,
