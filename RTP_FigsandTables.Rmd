...
hyps<- glmer(ResSpr ~ hhTenureSpPast + 
               ...
               frg.left+   (1|Org) , family = binomial, data = td.fg) 
# Wtr Otor
  #This is the best version, based on AIC scores and % variation explained...and ifs diff
