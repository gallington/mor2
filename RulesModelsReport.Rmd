...
output:
  ...
  pdf_document: default
---
-2019-12-6: versioned the prior itteration of this that included all the old model comparisons and restarted w new based on the new tabel of hypothesized relationships from our call on Dec. 5
...
[Update this to reflect new data table that includes Jay's forage use data...]
