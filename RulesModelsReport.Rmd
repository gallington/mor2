...
[removed ORg-level tenure code for now. see previous version to replace]
...
```{r}
  # just Pasture tenure, Rules, cbrm, SC1
...
OK need to *really* look at a series of nested models so can figure out what to show:
```{r}
